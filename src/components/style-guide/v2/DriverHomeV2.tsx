...
export function DriverHomeV2() {
  return (
    <div className="relative min-h-full bg-background">
      <div className="pb-[84px]">
        <header className="bg-ink-gradient px-4 py-3.5 text-center">
          <h1 className="text-[17px] font-bold tracking-wide text-brand-foreground">
