...
export function DriverOrderPoolV2() {
  return (
    <div className="relative min-h-full bg-background">
      <div className="pb-[84px]">
        <header className="flex items-center bg-ink-gradient px-4 py-3.5">
          <span className="size-5" />
          <h1 className="flex-1 text-center text-[17px] font-bold tracking-wide text-brand-foreground">
            有米出行 <span className="text-brand">YOMI</span>
          </h1>
          <Share2 className="size-5 text-brand-foreground" />
        </header>
