...
export function PassengerOrderFormV7() {
  return (
    <div className="relative min-h-full bg-background">
      <div className="pb-[112px]">
        <div className="pb-6">
          <header className="flex items-center gap-3 bg-haze px-4 py-3">
            ...
            <h1 className="flex-1 text-center text-[17px] font-bold text-ink">接机</h1>
            <span className="font-mono text-[11px] tracking-[0.18em] text-ink-soft/70">1 / 2</span>
          </header>
        </div>

        <div className="-mt-4 space-y-2.5 px-3.5">
      ...
      <div className="absolute inset-x-0 bottom-0 border-t border-ink/8 bg-haze-bottom px-4 pt-3 pb-4">
        ...
        <button className="mt-3 w-full rounded-2xl bg-brand py-3.5 text-[15px] font-bold text-brand-foreground shadow-float">
          提交订单
        </button>
      </div>
